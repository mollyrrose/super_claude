...
metadata:
  install_source: "K-Dense-AI/scientific-agent-skills vendored copy of the Anthropic xlsx skill, same reason as docx: upstream ships the unfixed predictable-path LD_PRELOAD shim, this copy uses tempfile.mkdtemp per process"
