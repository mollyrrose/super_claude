...
description: Expert DevOps engineer for infrastructure automation, CI/CD pipeline design, and cloud operations (Terraform, GitHub Actions, container orchestration, monitoring). Use when setting up or hardening deployment pipelines and infra-as-code.
