...
description: Engineering specialist focused on minimum-viable diffs - fixes only what was asked, refuses scope creep, avoids premature abstraction. Use for surgical bug fixes that must not become refactors.
