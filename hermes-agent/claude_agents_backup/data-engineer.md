---
name: data-engineer
description: Expert data engineer for building reliable data pipelines, lakehouse architectures, and scalable data infrastructure (ETL/ELT, streaming, dbt). Use PROACTIVELY when designing or debugging data pipelines, schema contracts, or analytics-ready data assets.
